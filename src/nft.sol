...
contract BaseERC721 {
    ...
    function mint(address to, uint256 tokenId) public {
        ...
        require(!_exists(tokenId)/**code*/, "ERC721: token already minted");
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        // 部分授权？
        require(
            /**code*/(msg.sender == owner) ||          // 发起者是所有者
            isApprovedForAll(owner, msg.sender),       // 发起者是完全授权者
